 ...
 *
 */
namespace socratesldduarte\DBEncryption\Traits;

use socratesldduarte\DBEncryption\Builders\EncryptionEloquentBuilder;
use socratesldduarte\DBEncryption\Encrypter;
